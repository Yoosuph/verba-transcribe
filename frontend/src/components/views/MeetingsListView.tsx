    ...
    <div className="flex-1 flex flex-col bg-[#F8FAFC] text-slate-900 overflow-hidden relative">
      ...
      <div className="flex-1 overflow-y-auto px-5 pt-4 pb-28 space-y-4">
        ...
        <div className="flex items-center justify-between pt-1">
          ...
          <div className="w-10 h-10 rounded-full bg-[#E5E9FF] text-[#2F45EE] font-bold text-xs flex items-center justify-center shadow-xs">
            AO
          </div>
        </div>
        ...
        <div className="relative">
          <div className="w-full bg-[#EEF2F6] hover:bg-[#E9EEF4] focus-within:bg-white focus-within:ring-2 focus-within:ring-[#2F45EE]/30 rounded-full px-4 py-2.5 flex items-center gap-2.5 transition-all">
        ...
        {filteredSessions.length === 0 ? (
          <div className="py-12 px-4 flex flex-col items-center justify-center text-center space-y-4">
            <div className="w-16 h-16 rounded-full bg-[#EEF2FF] text-[#2F45EE] flex items-center justify-center shadow-inner">
            ...
            <div className="space-y-1 max-w-xs">
              ...
              <p className="text-xs text-slate-500 leading-relaxed">
                Tap the <strong className="text-slate-800">Record</strong> button below to capture speech with live transcription, speaker diarization, and grounded summaries.
              </p>
            </div>
            <button
              onClick={onStartRecord}
              className="px-5 py-2.5 rounded-full bg-[#2F45EE] text-white text-xs font-semibold shadow-md shadow-indigo-500/20 active:scale-95 transition-all flex items-center gap-2"
            >
            ...
            {filteredSessions.map((session) => {
              ...
              return (
                <div
                  ...
                  className="bg-white rounded-2xl p-4 border border-slate-100/90 shadow-[0_2px_8px_rgba(0,0,0,0.03)] hover:shadow-md hover:border-slate-200 transition-all cursor-pointer touch-press"
                >
                  {/* Title & Time */}
                  ...
                  {isProcessing ? (
                    <div className="mt-2.5 mb-2">
                      <div className="flex items-center justify-between text-xs font-semibold text-[#2F45EE] mb-1.5">
                        <span className="animate-pulse">Analyzing & Summarizing...</span>
                      </div>
                      <div className="w-full h-1.5 bg-slate-100 rounded-full overflow-hidden">
                        <div className="w-[75%] h-full bg-[#2F45EE] rounded-full animate-pulse" />
                      </div>
                    </div>
                  ) : (
                  ...
                  <div className="flex items-center justify-between pt-1">
                    ...
                    {actionCount > 0 && (
                      <span className="px-2.5 py-0.5 rounded-full bg-[#EEF2FF] text-[#2F45EE] text-[11px] font-semibold">
      ...
      <div className="absolute bottom-3 left-0 right-0 flex justify-center pointer-events-none z-30">
        <button
          onClick={onStartRecord}
          className="pointer-events-auto bg-[#2F45EE] hover:bg-[#2437D8] text-white px-6 py-3 rounded-full flex items-center gap-2 shadow-[0_10px_25px_rgba(47,69,238,0.4)] font-semibold text-sm touch-press cursor-pointer transition-all active:scale-95"
        >
